const RegisterSuperAdminDTO = require("../dto/register_super_admin.dto");
...
class RegisterSuperAdminUseCase {
  ...
  async execute(data) {
    const dto = new RegisterSuperAdminDTO(data);
    ...
    if (!UsernamePolicy.validateSuperAdmin(username)) {
      throw new Error("Username Super Admin phải có dạng @admin.vn");
    }
    return this.superAdminRepository.register({
...
module.exports = RegisterSuperAdminUseCase;
